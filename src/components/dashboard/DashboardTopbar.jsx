...
import { Bell, Settings, ChevronRight, LogOut } from "lucide-react";
  ...
  return (
    <header className="h-14 border-b border-border bg-background-card/80 backdrop-blur-sm flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={() => onLogout()}
          className="cursor-pointer px-4 py-2 rounded-lg bg-background border border-border text-sm text-foreground-muted hover:text-white hover:border-accent/40 transition-all flex items-center gap-1.5"
        >
