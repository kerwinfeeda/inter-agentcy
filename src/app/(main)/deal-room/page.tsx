...
const lifecycle = [
  {
    ...
    icon: Search,
    title: "Discovery",
    desc: "Agent lists player / Club posts requirement",
  },
  {
    step: 2,
    icon: Target,
    title: "Pitch",
    desc: "Agent pitches to interested clubs",
  },
  {
    step: 3,
    icon: Handshake,
    title: "Negotiation",
    desc: "Deal Room created, structured offers",
  },
  {
    step: 4,
    icon: ShieldCheck,
    title: "Agreement",
    desc: "Terms agreed, compliance verified",
  },
  {
    step: 5,
    icon: FileText,
    title: "Execution",
    desc: "Medical, contracts, FIFA TMS",
  },
  {
    step: 6,
    icon: CheckCircle,
    title: "Completion",
    desc: "Deal closed, commissions distributed",
  },
];
...
const dealRoomFeatures = [
  {
    ...
    desc: "Buying club, selling club, agents, scouts, reps — all in one workspace.",
  },
  {
    icon: Handshake,
    title: "Structured Offers",
    desc: "Submit, counter, and track offers with full version history.",
  },
  {
    icon: FileText,
    title: "Document Management",
    desc: "Upload, share, and version-control contracts and documents.",
  },
  {
    icon: MessageSquare,
    title: "Threaded Messaging",
    desc: "Contextual conversations with complete audit trail.",
  },
  {
    icon: ClipboardList,
    title: "Task & Approvals",
    desc: "Assign tasks, request sign-offs, and track progress.",
  },
  {
    icon: Clock,
    title: "Deal Timeline",
    desc: "Milestone tracking from first contact to completion.",
  },
];
...
const aiFeatures = [
  {
    icon: BarChart3,
    title: "Deal Analyst",
    quote: "This offer is 15% below market rate. Consider countering at €X.",
  },
  {
    icon: Target,
    title: "Smart Matching",
    quote:
      "Club X just sold their starting CB. They need a replacement matching your player's profile.",
  },
  {
    icon: Scale,
    title: "Compliance Copilot",
    quote:
      "This fee structure exceeds FFAR caps. Here's a compliant alternative.",
  },
  {
    icon: FileSearch,
    title: "Contract Review",
    quote:
      "Upload a contract → AI highlights key clauses, risks, and omissions.",
  },
  {
    icon: TrendingUp,
    title: "Market Intel",
    quote: "Transfer window analytics, regional demand reports, fee trends.",
  },
  {
    icon: Route,
    title: "Network Navigator",
    quote: "You're 2 connections away from Club X's sporting director.",
  },
];
...
const complianceFeatures = [
  {
    icon: Scale,
    title: "FIFA FFAR Auto-Enforcement",
    desc: "3% salary cap, 10% transfer fee cap — automatically applied.",
  },
  {
    icon: UserCheck,
    title: "Licence Verification",
    desc: "Every participant verified before deal room access.",
  },
  {
    icon: Eye,
    title: "Full Audit Trail",
    desc: "Every action logged, timestamped, and exportable.",
  },
  {
    icon: ShieldCheck,
    title: "Minor Protections",
    desc: "Dual representation checks and minor safeguards built in.",
  },
  {
    icon: BarChart3,
    title: "Compliance Dashboard",
    desc: "Real-time deal health and regulatory status.",
  },
];
...
const financialFeatures = [
  {
    ...
    desc: "Track commissions across multi-party deals.",
  },
  {
    icon: Calculator,
    title: "Contingency Management",
    desc: "Sell-on clauses, performance bonuses, all tracked.",
  },
  {
    icon: Receipt,
    title: "Auto-Generated Invoices",
    desc: "Generate compliant invoices from deal data.",
  },
  {
    icon: PieChart,
    title: "Financial Analytics",
    desc: "Projections, summaries, and insights at a glance.",
  },
];
...
const roles = [
  {
    icon: Briefcase,
    title: "Agents",
    desc: "List players, pitch to clubs, manage deals, track commissions.",
  },
  {
    icon: Building2,
    title: "Clubs",
    desc: "Post requirements, receive pitches, manage negotiations.",
  },
  {
    icon: Search,
    title: "Scouts",
    desc: "Submit reports into pipeline, earn finder's fees.",
  },
  {
    icon: Network,
    title: "Reps & Introducers",
    desc: "Collaborate on deals, earn referral commissions.",
  },
  {
    icon: Users,
    title: "Players",
    desc: "Track deal progress, understand agent fees.",
  },
];
    ...
    <main className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-base sm:text-lg text-[#7B8794] max-w-3xl mx-auto mb-8">
            The only platform where agents, clubs, scouts, reps, and introducers
            discover opportunities, negotiate transfers, and close deals — with
            FIFA compliance built in and AI intelligence at every step.
          </p>
            ...
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                ...
                <div className="text-xs text-[#7B8794] mt-1">
                  {s.label.replace(s.value, "").trim() || s.label}
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            <Link
              href="/register"
              className="gradient-steel-btn px-8 py-3 rounded-full text-white font-semibold inline-flex items-center gap-2"
            >
              Get Early Access <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              href="/docs"
              className="px-8 py-3 rounded-full border border-[#4A5568] text-[#C0C7CE] font-semibold hover:bg-white/5 transition-colors"
            >
              View PRD
            </Link>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#7B8794] text-center max-w-2xl mx-auto mb-12">
            From discovery to deal completion — a structured lifecycle for every
            transfer.
          </p>
          ...
          <div className="hidden md:grid grid-cols-6 gap-4">
            {lifecycle.map((step, i) => (
              <div key={step.step} className="text-center relative">
                ...
                <div className="text-xs text-[#9AAAB8] font-semibold mb-1">
                  Step {step.step}
                </div>
            ...
            {lifecycle.map((step, i) => (
              <div key={step.step} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  {i < lifecycle.length - 1 && (
                    <div className="w-px flex-1 bg-[#4A5568]/40 mt-2" />
                  )}
                </div>
                <div className="pb-4">
                  <div className="text-xs text-[#9AAAB8] font-semibold">
                    Step {step.step}
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-[#7B8794] mb-4">
                Agents list players as Available, Loan, or Seeking Club.
                Protected listings ensure one agent per player. Jose AI
                auto-generates pitch summaries from player data.
              </p>
              <div className="flex flex-wrap gap-2">
                {["Available", "Loan", "Seeking Club"].map((tag) => (
                  <span
                    key={tag}
                    className="text-xs px-3 py-1 rounded-full bg-[#4A5568]/20 text-[#9AAAB8] border border-[#4A5568]/30"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-[#7B8794] mb-4">
                Clubs post exactly what they need — position, budget, timeline.
                Public or private listings. Auto-matching sends notifications
                when a player fits.
              </p>
              <div className="flex flex-wrap gap-2">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="card card-hover p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-[#7B8794]">
                  Dedicated marketplace for loan deals with option-to-buy
                  tracking.
                </div>
              </div>
            </div>
            <div className="card card-hover p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-[#7B8794]">
                  Browse and pitch free agents with contract-expired status.
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 border-t border-[#4A5568]/20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#7B8794] text-center max-w-2xl mx-auto mb-12">
            The structured workspace where transfers happen. Every party, every
            document, every decision — in one place.
          </p>
      ...
      <section className="py-20 px-4 border-t border-[#4A5568]/20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#7B8794] text-center max-w-2xl mx-auto mb-12">
            Your AI copilot analyses every deal, flags risks, and surfaces
              ...
              <div key={f.title} className="card card-hover p-6">
                ...
                <div className="bg-[#4A5568]/10 border border-[#4A5568]/20 rounded-lg p-3 mt-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-[#C0C7CE] italic">
                      &ldquo;{f.quote}&rdquo;
                    </p>
                  </div>
                </div>
      ...
      <section className="py-20 px-4 border-t border-[#4A5568]/20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#7B8794] text-center max-w-2xl mx-auto mb-12">
            FIFA regulations enforced automatically. Every deal compliant by
            default.
          </p>
      ...
      <section className="py-20 px-4 border-t border-[#4A5568]/20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#7B8794] text-center max-w-2xl mx-auto mb-12">
            Whether you represent, recruit, scout, or play — DealRoom works for
            you.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {pricing.map((p) => (
              <div
                key={p.tier}
                className={`card p-6 relative ${p.popular ? "border-[#9AAAB8]/40" : ""}`}
              >
                {p.popular && (
                ...
                <div className="mb-2">
                  ...
                  {p.period && (
                    <span className="text-sm text-[#7B8794]">{p.period}</span>
                  )}
                </div>
                ...
                <ul className="space-y-2">
                  {p.features.map((f) => (
                    <li
                      key={f}
                      className="flex items-center gap-2 text-xs text-[#C0C7CE]"
                    >
      ...
      <section className="py-20 px-4 border-t border-[#4A5568]/20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[#7B8794] mb-8">
            Join the platform that&apos;s redefining how football transfers
            happen.
          </p>
