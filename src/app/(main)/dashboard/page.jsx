...
const activityItems = [
  {
    text: "New offer received for Emmanuel Osei from Club Brugge — €4.2M",
    time: "25 min ago",
  },
  ...
  {
    text: "Due diligence documents submitted for Kwame Mensah",
    time: "3h ago",
  },
  {
    text: "Commission payment received: €18,500 (André Santos deal)",
    time: "5h ago",
  },
  {
    text: "Club Brugge viewed Emmanuel Osei&apos;s profile 3 times today",
    time: "6h ago",
  },
  {
    text: "New scouting report received: Ibrahim Touré (ASEC Mimosas)",
    time: "8h ago",
  },
  {
    text: "Galatasaray increased offer for Ahmed Hassan to €5.5M",
    time: "12h ago",
  },
  {
    text: "Transfer window deadline reminder: 18 days remaining",
    time: "1d ago",
  },
...
const upcomingEvents = [
  {
    title: "Meeting with Club Brugge sporting director",
    date: "Feb 15, 2026 — 10:00",
    type: "meeting",
  },
  { title: "Transfer window deadline", date: "Mar 4, 2026", type: "deadline" },
  {
    title: "Contract expiry: Lucas Ferreira",
    date: "Mar 31, 2026",
    type: "expiry",
  },
  {
    title: "Medical — Youssef El-Hadj at Brighton",
    date: "Feb 18, 2026 — 09:00",
    type: "medical",
  },
  {
    title: "FIFA Agent Compliance renewal due",
    date: "Apr 1, 2026",
    type: "compliance",
  },
];
      ...
      <div className="card rounded-xl p-6">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1">
          {pipelineStages.map((s) => (
            <div
              key={s.label}
              className="flex items-center gap-1.5 text-xs text-foreground-dim"
            >
