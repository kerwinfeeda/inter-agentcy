...
export default function IntroducerNetworkPage() {
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-foreground-muted mt-1">
          Your professional contacts across the football industry
        </p>
      </div>
        ...
        {filtered.map((c, i) => (
          <div key={i} className="card rounded-xl p-5 card-hover">
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="text-xs text-foreground-muted bg-background-elevated px-2 py-1 rounded">
                {c.region}
              </span>
            </div>
