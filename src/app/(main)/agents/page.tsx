...
> = {
  agents: {
    ...
    description:
      "Execute transfers, negotiate contracts, and manage players with full FIFA compliance.",
  },
  scouts: {
    icon: Search,
    label: "Scouts",
    ...
    description:
      "Discover talent, create reports, and earn finder's fees by connecting players with agents.",
  },
  reps: {
    icon: Users,
    label: "Representatives",
    color: "from-[#7B8794] to-[#9AAAB8]",
    description:
      "Manage player careers, build brands, and collaborate with licensed agents for deal execution.",
  },
  introducers: {
    icon: Link2,
    label: "Introducers",
    ...
    description:
      "Connect players, agents, and clubs. Earn referral commissions on every introduction.",
  },
};
  ...
  agents: [
    {
      ...
      split: "70/30",
      features: [
        "Basic CRM (up to 10 players)",
        "Limited scouting reports (5/month)",
        "Community forum access",
        "FIFA regulation reference",
    ...
    },
    {
      ...
      split: "75/25",
      features: [
        "Full CRM (unlimited players)",
        "Scouting integrations (Wyscout)",
        "Compliance suite",
    ...
    },
    {
      ...
      features: [
        "Everything in Pro",
        "Priority club introductions",
        "StatsBomb advanced analytics",
        "Video analysis suite",
        "Dedicated account manager",
        "Mentorship matching",
        "Transfer marketplace priority",
        "Custom branding",
        "Phone support",
      ],
      cta: "Go Elite",
  ...
  scouts: [
    ...
    },
    {
      ...
      features: [
        ...
        "Finder's fee tracking",
        "Advanced player search",
        "Report templates",
        "Priority in agent feeds",
        "Email & chat support",
      ],
      cta: "Go Pro",
      highlighted: true,
    },
    {
      ...
      features: [
        ...
        "Wyscout & StatsBomb access",
        "Priority agent matching",
        "Escrow protection on finder's fees",
        "Video analysis tools",
        "Mentorship from senior scouts",
        "50GB video storage",
        "Dedicated support",
      ],
      cta: "Go Elite",
  ...
  reps: [
    {
      ...
      features: [
        "Up to 3 players",
        "Basic career management tools",
        "Marketplace agent access",
        "Community access",
    ...
    },
    {
      ...
      features: [
        "Unlimited players",
        "Full brand suite + PR tools",
        "Dedicated licensed agent partner",
        "Legal review credits (2/month)",
        "Content creation tools",
        "Sponsorship matching",
        "Player website builder",
        "Phone support",
      ],
      cta: "Go Elite",
      highlighted: false,
  ...
  introducers: [
    ...
    },
    {
      ...
      features: [
        ...
        "15% referral rate",
        "Volume bonuses (up to 20%)",
        "Verified Introducer badge",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-foreground-muted max-w-2xl mx-auto text-lg">
            Choose your role in the ecosystem. Every plan includes platform
            access, compliance tools, and our global network.
          </p>
        </div>
        ...
        <div className="text-center mb-12">
          <div
            className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${info.color} flex items-center justify-center mx-auto mb-4`}
          >
        ...
        {/* Pricing Cards */}
        <div
          className={`grid grid-cols-1 gap-8 mb-24 ${currentTiers.length === 2 ? "md:grid-cols-2 max-w-3xl mx-auto" : "md:grid-cols-3"}`}
        >
          {currentTiers.map((tier) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center ${tier.highlighted ? "bg-accent" : "bg-white/5"}`}
                >
              ...
              <p className="text-sm text-accent font-medium mb-6">
                {activeRole === "introducers"
                  ? `Referral rate: ${tier.split}`
                  : `Commission split: ${tier.split}`}
              </p>
