...
const flowSteps = [
  {
    ...
    description:
      "Discover talent across the globe. Create scouting reports, upload video, track player development.",
    action: "Find talent →",
  },
  {
    icon: Users,
    ...
    description:
      "Manage player careers, build personal brands, develop social media presence, plan career trajectories.",
  ...
  },
  {
    ...
    description:
      "Execute transfers, negotiate contracts, handle FIFA-regulated transactions. The licensed backbone of every deal.",
  ...
  },
  {
    ...
    borderColor: "border-accent/30",
    description:
      "Access verified talent pipelines, work with compliant agents, streamline recruitment and transfers.",
    action: "Sign players",
  },
];
...
const compliancePoints = [
  {
    title: "Scouts feed agents",
    description:
      "Scouts discover talent and earn finder's fees. When a deal materializes, the licensed agent handles all regulated activities.",
  },
  {
    title: "Reps work through agents",
    description:
      "Representatives manage player careers and brands, but all contract negotiations and transfers flow through a licensed agent on the platform.",
  },
  {
    title: "Introducers earn referrals",
    description:
      "Introducers connect parties and earn referral commissions. The licensed agent always executes the regulated transaction.",
  },
  {
    title: "Agents stay compliant",
    description:
      "Every deal on the platform is automatically checked against FIFA Football Agent Regulations. Commission caps, disclosure requirements, and documentation are enforced.",
  },
];
...
const revenueFlows = [
  {
    role: "Scout",
    example: "Discovers a player in Nigeria",
    earns: "Finder's fee (% of agent commission)",
    split: "Up to 75/25",
  },
  {
    role: "Representative",
    example: "Manages player brand & career",
    earns: "Management fee + deal split",
    split: "Up to 80/20",
  },
  {
    role: "Licensed Agent",
    example: "Executes €5M transfer",
    earns: "Agent commission (FIFA-capped)",
    split: "Up to 85/15",
  },
  {
    role: "Introducer",
    example: "Connects player with club",
    earns: "Referral commission",
    split: "Up to 15% of deal commission",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-foreground-muted leading-relaxed">
            Football representation isn&apos;t just agents. It&apos;s scouts who
            discover talent, representatives who manage careers, introducers who
            connect parties, and agents who execute deals. Inter Agentcy brings
        ...
        <div className="mb-24">
          ...
          <p className="text-foreground-muted text-center mb-12 max-w-xl mx-auto">
            Every role feeds into the next. Everyone adds value. Everyone earns.
          </p>
          ...
          <div className="relative max-w-4xl mx-auto">
              ...
              {flowSteps.map((step, i) => (
                <div key={step.title}>
                  ...
                  >
                    ...
                    >
                      <div
                        className={`card rounded-2xl p-6 border ${step.borderColor} inline-block max-w-md`}
                      >
                        <div
                          className={`w-10 h-10 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center mb-3 ${i % 2 === 0 ? "md:ml-auto" : ""}`}
                        >
            ...
            <div className="mt-8 card rounded-2xl p-6 border border-accent/20 max-w-md mx-auto text-center">
              ...
              <p className="text-sm text-foreground-muted">
                Connect any parties at any stage. Earn referral commissions on
                every successful introduction that leads to a deal.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Everyone Gets Paid.{" "}
              <span className="gradient-text">Everyone Stays Compliant.</span>
            </h2>
            <p className="text-foreground-muted max-w-2xl mx-auto">
              FIFA regulations require licensed agents for certain activities.
              Our platform ensures unlicensed participants always work through
              licensed agents — automatically and transparently.
            </p>
          </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-12">
            ...
            <p className="text-foreground-muted max-w-xl mx-auto">
              More participants → better talent discovery → more deals → more
          ...
          <div className="card rounded-2xl p-8 mb-10 max-w-3xl mx-auto">
            ...
            <div className="flex justify-center mt-6">
              <div className="flex items-center gap-2 text-sm text-foreground-muted">
                ...
                <span>
                  Growth compounds — more deals attract more participants
                </span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {revenueFlows.map((r) => (
                    <tr
                      key={r.role}
                      className="border-b border-border hover:bg-background-elevated"
                    >
          ...
          <div className="card rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-foreground-muted mb-8 max-w-xl mx-auto">
                Agent, scout, representative, or introducer — there&apos;s a
                plan built for you.
              </p>
