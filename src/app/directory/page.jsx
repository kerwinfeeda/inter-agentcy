...
export default function DirectoryPage() {
  const sortedAgencies = [...agencies].sort(
    (a, b) => parseValue(b.value) - parseValue(a.value),
  );
  const featured = sortedAgencies.slice(0, 15);
  const countries = new Set(agencies.map((a) => a.country).filter(Boolean));
  const totalValue = sortedAgencies.reduce(
    (sum, a) => sum + parseValue(a.value),
    0,
  );
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-foreground-muted max-w-2xl mx-auto mb-10">
            The most comprehensive database of verified football agencies and
            agents worldwide. Trusted source for player representation
            intelligence.
          </p>
          ...
          <div className="card p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">
                    Gold Verified — Agencies
                  </h3>
                  <p className="text-xs text-foreground-dim leading-relaxed">
                    Awarded to agencies verified through public records,
                    regulatory filings, and industry sources. Confirms
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-white mb-1">
                    Blue Verified — Agents
                  </h3>
                  <p className="text-xs text-foreground-dim leading-relaxed">
                    Awarded to individual agents verified through licensing
                    records and professional activity. Confirms identity and
                    credentials.
                  </p>
                </div>
              </div>
      ...
      <section className="pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/directory/agencies"
              className="text-sm text-accent-steel hover:text-accent-light transition-colors flex items-center gap-1"
            >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="card p-8 text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">
              Trusted Source for Football Intelligence
            </h2>
            <p className="text-sm text-foreground-dim max-w-xl mx-auto">
              All listings are sourced from public records, regulatory
              databases, and verified industry contacts. Inter Agentcy is the
              definitive directory for football agency intelligence.
            </p>
          </div>
        </div>
      </section>
