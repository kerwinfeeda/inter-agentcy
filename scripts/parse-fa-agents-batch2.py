...
RAW_FILE = "/Users/kerwinalabi/.openclaw/workspace/inter-agentcy/src/data/fa-agents-batch2.txt"
...
def parse_line(line):
    ...
    auth_until = None
    if date_str:
        auth_until = date_str  # Keep DD/MM/YYYY format as specified
    words = name.split()
    processed = []
    for w in words:
...
print(f"Parsed {len(fa_agents)} FA agents from batch 2")
